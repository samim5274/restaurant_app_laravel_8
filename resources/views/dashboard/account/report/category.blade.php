                        ...
                        <div class="col-lg-12 col-md-12 grid-margin stretch-card">
                            <div class="card mt-2">
                                <div class="card-body p-2 p-md-4">
                                    ...
                                    <form action="{{ url('/search-category') }}" method="GET" class="p-3 border rounded shadow-sm bg-white">
                                        @csrf
                                        <div class="row mb-3">
                                            <div class="col-md-6">
        ...
        <script>
            ...
            function printreport() {
                var header = `
                    ...
                    <h3 style="text-align:center;">Selected day and category wise Report</h3>
                    <hr>
                `;
