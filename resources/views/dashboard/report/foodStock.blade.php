        ...
        <div class="main-panel">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h3 class="page-title"> Stock Report: {{$stock[0]->food->name}}</h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#" onclick="printreport()"><i class="mdi mdi-printer"></i> Print</a></li>
                            <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-arrow-down-bold-circle-outline" stlye="font-size: 1rem;"></i> Download</a></li>
                            <li class="breadcrumb-item"><a href="{{url('/stock-report')}}">Stock Report</a></li>
                            <li class="breadcrumb-item"><a href="{{url('/item-wise-report-view')}}">Item View</a></li>
                                    ...
                                    <table class="table table-hover  mb-0" id="printableTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$val->date}}</td>
                                                <td>{{$val->food->name}}</td>
                                                <td>{{$val->stockIn}} pcs</td>
                                                <td>{{$val->stockOut}} pcs</td>
    ...
    <script>
        ...
        function printreport() {
            var header = `
                ...
                <h3 style="text-align:center;">Total Stock Report</h3>
                <hr>
            `;
