        ...
        <div class="main-panel">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header">
                    <h3 class="page-title">Item and Food Wise Stock Report</h3>
                    ...
                    <div class="col-lg-12 col-md-12 grid-margin stretch-card">
                        <div class="card mt-2">
                            <div class="card-body p-2 p-md-4">
                                <form action="{{url('/day-wise-stock-report-search')}}" method="GET" class="p-3 border rounded shadow-sm bg-white">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <select name="cbxFood" id="cbxFood" required class="form-control">
